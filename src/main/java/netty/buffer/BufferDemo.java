...
/**
 * Created by qincasin on 2021/7/13.
 */
public class BufferDemo {
     ...
     * 如果buffer写满了，position的值就和buffer.capacity一致。
     *
...
//            byteBuffer.flip();    一定要注意！
     ...
     * 数据（还没有读过的数据），先将这些数据移到左边，然后在这个基础上再开始写入。
     */
    ...
    private static SocketChannel socketChannel(){return null;}
}
